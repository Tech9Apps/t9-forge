...
Require fresh verification evidence before claiming work is complete, fixed, or passing.
...
Run the appropriate command for your claim:
...
<!-- Examples for common stacks:
  Node/TypeScript: npm run build && npx eslint . && npx tsc --noEmit && npm test
